/**
 * Cross-site navigation bar - canonical shared version for the website estate.
 *
 * Injects sibling-site links plus a standalone "Part of the Elusion Works
 * web estate" line into the page footer. Mirrors the per-repo copies under
 * sites/axylusion/ and sites/ghost-in-the-models/ - keep this file in sync
 * if those are ever regenerated from a shared source.
 *
 * Usage: include on every page as
 *   <script src="/shared/cross-site-nav.js" defer></script>
 * or inline a copy of the IIFE in the site's footer.
 */
(function () {
  ...
  const legacyRouteMap = {
    ...
    'koltregaskes.github.io/elusion-works': 'elusion-works'
  };
  ...
  shell.appendChild(linksRow);

  // Skip the "Part of the Elusion Works estate" line when we're already on Elusion Works itself.
  if (activeSiteId !== 'elusion-works') {
